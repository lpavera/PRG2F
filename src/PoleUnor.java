...
public class PoleUnor {
    public static void main(String[] args) {
        ...
        String novejSong = sc.nextLine();
        System.out.println("Zadej její hodnocení");
        double novejRating = sc.nextDouble();

        songs[freeSpace] = novejSong;
        ratings[freeSpace] = novejRating;
        freeSpace++;

        for (int i = 0; i < freeSpace ; i++){
            System.out.println("song: " + songs[i] + " " + "hodoceni: " + ratings[i]);
        }
    }
}
